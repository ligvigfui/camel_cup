...
impl CamelCup {
    ...
    pub fn display (&self) {
        ...
        println!("{} cards bet on the winer camel", Color!(self.winer_endgametipcards.len()).bold(true));
        println!("{} cards bet on the losing camel", Color!(self.loser_endgametipcards.len()).bold(true));
    }
