        ...
        for i in 0..ordered_output.len() {
            match 
                match ordered_output[i].0 {
                    ...
                    1 => game.place_card(game.current_player(), 1, true),
                    2 => game.place_card(game.current_player(), 2, true),
                    3 => game.place_card(game.current_player(), 3, true),
                    4 => game.place_card(game.current_player(), 4, true),
                    5 => game.place_card(game.current_player(), 5, true),
                    6 => game.place_card(game.current_player(), 6, true),   
                    7 => game.place_card(game.current_player(), 7, true),
                    8 => game.place_card(game.current_player(), 8, true),
                    9 => game.place_card(game.current_player(), 9, true),
                    10 => game.place_card(game.current_player(), 10, true),
                    11 => game.place_card(game.current_player(), 11, true),
                    12 => game.place_card(game.current_player(), 12, true),
                    13 => game.place_card(game.current_player(), 13, true),
                    14 => game.place_card(game.current_player(), 14, true),
                    15 => game.place_card(game.current_player(), 15, true),
                    16 => game.place_card(game.current_player(), 16, true),
                    17 => game.place_card(game.current_player(), 1, false),
                    18 => game.place_card(game.current_player(), 2, false),
                    19 => game.place_card(game.current_player(), 3, false),
                    20 => game.place_card(game.current_player(), 4, false),
                    21 => game.place_card(game.current_player(), 5, false),
                    22 => game.place_card(game.current_player(), 6, false),
                    23 => game.place_card(game.current_player(), 7, false),
                    24 => game.place_card(game.current_player(), 8, false),
                    25 => game.place_card(game.current_player(), 9, false),
                    26 => game.place_card(game.current_player(), 10, false),
                    27 => game.place_card(game.current_player(), 11, false),
                    28 => game.place_card(game.current_player(), 12, false),
                    29 => game.place_card(game.current_player(), 13, false),
                    30 => game.place_card(game.current_player(), 14, false),
                    31 => game.place_card(game.current_player(), 15, false),
                    32 => game.place_card(game.current_player(), 16, false),
                    33 => game.move_tip_card(game.current_player(), "White"),
                    34 => game.move_tip_card(game.current_player(), "Yellow"),
                    35 => game.move_tip_card(game.current_player(), "Orange"),
                    36 => game.move_tip_card(game.current_player(), "Blue"),
                    37 => game.move_tip_card(game.current_player(), "Green"),
                    38 => game.end_game_bet(game.current_player(), true, "White"),
                    39 => game.end_game_bet(game.current_player(), true, "Yellow"),
                    40 => game.end_game_bet(game.current_player(), true, "Orange"),
                    41 => game.end_game_bet(game.current_player(), true, "Blue"),
                    42 => game.end_game_bet(game.current_player(), true, "Green"),
                    43 => game.end_game_bet(game.current_player(), false, "White"),
                    44 => game.end_game_bet(game.current_player(), false, "Yellow"),
                    45 => game.end_game_bet(game.current_player(), false, "Orange"),
                    46 => game.end_game_bet(game.current_player(), false, "Blue"),
                    47 => game.end_game_bet(game.current_player(), false, "Green"),
